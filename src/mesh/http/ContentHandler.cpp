...
static int32_t callBlockchain()
{
    ...
    //                                                             std::bind(&HttpAPI::sendSecret, &webAPI,
    //                                                             std::placeholders::_1));
    ...
    Serial.println("Blockchain call");
    Serial.println(moduleConfig.wallet.enabled);
    Serial.println(moduleConfig.wallet.public_key);
    Serial.println(moduleConfig.wallet.private_key);
    Serial.println(moduleConfig.payment.enabled);
    Serial.println(moduleConfig.payment.address);
    Serial.println(moduleConfig.payment.amount);
    return 5000;
}
